...
import { idlFactory } from './react_tailwind.did.js';
export { idlFactory } from './react_tailwind.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.REACT_TAILWIND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./react_tailwind.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the react_tailwind canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./react_tailwind.did.js")._SERVICE>}
 */
export const react_tailwind = createActor(canisterId);
